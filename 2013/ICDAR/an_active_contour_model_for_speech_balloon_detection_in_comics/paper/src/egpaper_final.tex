...
%%%%%%%%% ABSTRACT
\begin{abstract}
   The ABSTRACT sdf is to be in fully-justified italicized text, at the top
...
either has been or will be submitted during the CVPR 2013 review period to
{\bf either a journal} or any conference (including CVPR 2013) or any
workshop (including CVPR 2013 workshops).  {\bf Note that this is consistent
with CVPR 2011 and CVPR 2012 but a strengthening from the policy of some
previous CVPRs.  Papers violating this condition will be rejected and a list
of violating authors may be included in the proceedings.}
